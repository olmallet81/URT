...
template <typename T>
inline KPSS<T>::KPSS(const Vector<T>& data, int lags, const std::string& trend) : ur(data, lags, trend)
{
...
template <typename T>
inline KPSS<T>::KPSS(const Vector<T>& data, const std::string lags_type, const std::string& trend) : ur(data, 0, trend)
{
   ur::test_name = _test_name;
   ur::valid_trends = _valid_trends;
...
template <typename T>
inline void KPSS<T>::compute_stat()
{
...
template <typename T>
inline const T& KPSS<T>::statistic()
{  
