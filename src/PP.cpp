...
template <typename T>
inline PP<T>::PP(const Vector<T>& data, int lags, const std::string& trend, const std::string& test_type, bool regression) : ur(data, lags, trend, regression)
{   
...
template <typename T>
inline PP<T>::PP(const Vector<T>& data, const std::string& lags_type, const std::string& trend, const std::string& test_type, bool regression) : ur(data, 0, trend, regression)
{
   ur::test_name = _test_name;
   ur::test_type = test_type;
   ur::valid_trends = _valid_trends;
