...
template <typename T>
inline DFGLS<T>::DFGLS(const Vector<T>& data, int lags, const std::string& trend, bool regression) : ur(data, lags, trend, regression)
{
...
template <typename T>
inline DFGLS<T>::DFGLS(const Vector<T>& data, const std::string& method, const std::string& trend, bool regression) : ur(data, method, trend, regression)
{
   ur::test_name = _test_name;
   ur::valid_trends = _valid_trends;
}
...
template <typename T>
inline const T& DFGLS<T>::statistic()
{
